  ...
  return (
    <div className="min-h-screen bg-rail-bg py-8">
      <div className="max-w-2xl mx-auto px-4 sm:px-6">
        ...
        {/* Header */}
        <div className="mb-6">
          <h1 className="font-syne font-bold text-rail-blue text-2xl mb-1">File a Complaint</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-syne font-bold text-rail-blue">🇮🇳 Select Language</h3>
          </div>
          <select
            value={language}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-syne font-bold text-rail-blue">Complaint Description</h3>
            <button
          ...
          />
          <p className="text-xs text-rail-gray font-dm mt-1">{description.length} characters</p>
        </div>

        {/* Voice Recording */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-4">
          <h3 className="font-syne font-bold text-rail-blue mb-3">Voice Recording (Proof)</h3>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-4">
          <h3 className="font-syne font-bold text-rail-blue mb-3">
            Photo Evidence <span className="text-rail-gray text-xs font-dm font-normal">(max 5)</span>
          </h3>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
          <h3 className="font-syne font-bold text-rail-blue mb-3">
            Journey Details <span className="text-rail-gray text-xs font-dm font-normal">(optional)</span>
          </h3>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs font-medium text-gray-600 block mb-1.5">PNR Number</label>
            ...
            <div>
              <label className="text-xs font-medium text-gray-600 block mb-1.5">Coach Number</label>
              <div className="relative">
