  ...
  useEffect(() => {
    ...
    const fetchComplaints = async () => {
      ...
      try {
        ...
        console.log("FORMATTED:", formattedComplaints);
          ...
          {[
            ...
            >
              ...
              {loading ? (
                ...
                <p className={`font-syne font-bold text-2xl ${s.text}`}>
                  {s.value}
                </p>

              )}

              <p className="text-xs text-rail-gray font-dm mt-0.5">
                {s.label}
              </p>
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs text-rail-gray font-dm capitalize">
                            {c.priority}
                          </span>
                      ...
                      <h3 className="font-syne font-bold text-rail-blue mb-2">
                        {c.title}
                      </h3>

                      <div className="flex items-center gap-3 text-xs text-rail-gray font-dm">

                        <span>🚂 Train {c.train}</span>
                    ...
                    <div className="flex flex-col items-end gap-3">
                      ...
                      <span
                        className={`flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full ${s.bg} ${s.text}`}
                      >
                        {s.icon} {s.label}
                      </span>
                      ...
                      <Link
                        ...
                        className="text-xs text-rail-mid font-dm hover:text-rail-blue"
                      >
                        View Details →
                      </Link>
